...
本リポジトリは OSS として公開する **Futa-e Player** 専用です。**Futa-e Cloud** は別リポジトリ（非公開）で実装・運用する前提とし、本計画内の Cloud 記述は概念整理に留めますの。

# 1. V1 の定義

## 1.1 目標

- **Futa-e Player（無料・OSS 可）**：
  ローカルで完結する“蓋絵プレイヤー”。
...
## Phase 2：Futa-e Player v1（無料・OSS）の完成
